...
#        x = np.loadtxt(open('timestamp.csv', "rb"), dtype=float, delimiter=",", skiprows=1)[:,1:]
#        y = np.loadtxt(open('timestamp.csv', "rb"), dtype=float, delimiter=",", skiprows=1)[:,:1]
        y = np.loadtxt(open('timestamp.csv', "rb"), dtype=float, delimiter=",", converters={0:force_float}, skiprows=1)
