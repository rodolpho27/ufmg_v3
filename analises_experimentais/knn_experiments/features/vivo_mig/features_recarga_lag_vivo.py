...
class Analysis:  
    ...
    def run(self):
        ...
        index_set = ['id_client', 'mean', 'std', 'lag_1', 'lag_2', 'lag_3', 'lag_4', 'lag_5', 'lag_6', 'lag_7', 'lag_8', 'lag_9', 'lag_10']
        self.filename = 'features_recharge_calls_lag_vivo_iuri.csv'
        ...
        for call in self.calls_clients:
            ...
            writer.writerow({'id_client': client,
        ...
        self.filename = 'features_recharge_sales_lag_vivo_iuri.csv'
        csvfile = open(self.filename, 'wb')
        writer = csv.DictWriter(csvfile, fieldnames=index_set, delimiter=",")
        writer.writeheader()
